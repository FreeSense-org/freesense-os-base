...
for value in ("minimum_interval: timedelta = timedelta(hours=20)",
              ...
              "select_deletion_batch", '"candidate_groups_sha256"',
              '"deferred_totals"', '"actionable_by_bucket"',
              '"max_delete_objects_per_bucket"',
...
for value in ("freesense.cloud-image/v1", "qemu-img convert",
              ...
              "FreeSense-base", "FreeSense-kernel-FreeSense", "FreeSense-rc",
              "FreeSense-repoc", "FreeSense-system",
              ...
              "install -f -y -r FreeSenseAssembly",
              'package_owner=$(pkg which "/etc/${boot_hook}")',
              "*FreeSense-system-*)",
